            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered text-center" id="data">
                        ...
                        <a href="/operator/formulir/create" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Tambah</a>
                        <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center mb-1">
                                            <a href="/operator/formulir/{{ $item->id }}/edit "
                                                class="btn btn-success  mb-2">Edit</a>

                                            <form action="/operator/formulir/{{ $item->id }}" method="POST">
                                                @method ('delete')
                                                @csrf
