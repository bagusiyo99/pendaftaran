                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="content-inner-page">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p>Nam scelerisque tristique dolor vitae tincidunt. Aenean quis massa uada mi elementum
                                    ...
                                    Nulla commodo
                                    iaculis ligula, ac dapibus quam ornare ut. Praesent ac hendrerit sem, et tempus sem
                                </p>
                            </div><!-- col end -->
                        </div><!-- 1st row end-->
                        ...
                        <div id="page-slider" class="page-slider">
                            <div class="item">
                                <img loading="lazy" class="img-fluid" src="images/projects/project1.jpg"
                                    alt="project-slider-image" />
                            </div>

                            <div class="item">
                                <img loading="lazy" class="img-fluid" src="images/projects/project2.jpg"
                                    alt="project-slider-image" />
                            </div>
                        </div><!-- Page slider end -->
